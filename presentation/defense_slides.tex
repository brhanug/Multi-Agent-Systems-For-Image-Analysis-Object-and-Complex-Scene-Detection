...
\vspace{0.5mm}
\tiny\textit{Locally, Primary and Critic are the same model instance -- a real test found this catches 0/25 self-contradictions (Slide 2.3/A.5); frontier mode's independent-model pair remains unverified.}
\normalsize
\vspace{0.5mm}
