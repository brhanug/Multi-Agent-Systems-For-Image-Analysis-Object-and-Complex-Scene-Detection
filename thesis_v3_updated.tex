...
\begin{table}[!htbp]
\centering
\caption{Visual Trend Analysis: Object Frequency by Decade.}
...
\begin{table}[!htbp]
\centering
\caption{E2: Agent F1 Ablation vs Gold Labels ($n=500$, synthetic baseline). Best F1 per column highlighted.}
...
\begin{table}[!htbp]
\centering
\caption{E4: Agent F1 by Scene Complexity Bin (synthetic labels, $n=500$).}
