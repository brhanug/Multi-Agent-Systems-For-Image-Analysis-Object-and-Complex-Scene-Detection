...
While these works validate the multi-agent paradigm in domains such as robotics, medical imaging, and autonomous driving, this thesis extends the multi-agent consensus model to the unique challenges of cultural heritage preservation. By decoupling validation and enrichment roles (Section~\ref{sec:e3_decoupling}) and routing uncertainty-driven conflicts to human reviewers, our framework specifically targets the epistemic ambiguity inherent in historical visual archives.
