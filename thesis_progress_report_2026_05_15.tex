...
\begin{itemize}[leftmargin=2em, noitemsep]
  \item \textbf{Spatial Domain Gap:} While YOLOv11m achieved a proxy mAP50 of 0.989 on synthetic data, its performance dropped to a real human mAP50 of \textbf{0.1902} on real historical images (a $-0.7988$ decay).
