...
\begin{itemize}[leftmargin=2em, noitemsep]
  \item \textbf{Spatial Domain Gap:} While YOLOv11m achieved a proxy mAP50 of 0.989 on synthetic data, its performance dropped to a real human mAP50 of \textbf{0.1316} on real historical images (a $-0.8574$ decay).
...
Inter-annotator reliability ($\kappa \geq 0.1555$) & \textcolor{accentgreen}{\textbf{Complete}} & — \\
