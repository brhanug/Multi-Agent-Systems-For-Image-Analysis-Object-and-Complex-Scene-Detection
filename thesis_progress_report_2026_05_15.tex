...
To move thesis claims from \textit{``proxy-validated''} to \textit{``human-measured,''} a rigorous human baseline audit was executed over \textbf{801 expert-reviewed images}. To validate inter-annotator dynamics, an independent 100-image spatial and semantic audit was conducted by a second domain expert in Label Studio.
